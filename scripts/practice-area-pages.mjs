...
export const PRACTICE_AREA_PAGES = {
  ...
  "aurora-personal-injury-attorney": { city: "aurora", topic: "other", label: "Personal Injury Overview" },
  ...
  "boulder-off-road-recreational-vehicle-accident-attorney": { city: "boulder", topic: "motor-vehicle", label: "Off-Road Vehicle Accidents" },
  ...
  "denver-amazon-truck-accident-lawyer": { city: "denver", topic: "motor-vehicle", label: "Amazon Truck Accidents" },
  ...
  "denver-drowsy-driving-accident-lawyer": { city: "denver", topic: "motor-vehicle", label: "Drowsy Driving Accidents" },
  "denver-drunk-driving-accident-lawyer": { city: "denver", topic: "motor-vehicle", label: "Drunk Driving Accidents" },
  "denver-scooter-accident-lawyer": { city: "denver", topic: "motor-vehicle", label: "E-Scooter Accidents" },
  "denver-fedex-truck-accident-lawyer": { city: "denver", topic: "motor-vehicle", label: "FedEx Truck Accidents" },
  "denver-garbage-truck-accident-lawyer": { city: "denver", topic: "motor-vehicle", label: "Garbage Truck Accidents" },
  ...
  "denver-side-impact-accident-lawyer": { city: "denver", topic: "motor-vehicle", label: "Side-Impact Accidents" },
  "denver-taxi-accident-lawyer": { city: "denver", topic: "motor-vehicle", label: "Taxi Accidents" },
  "denver-tow-truck-accident-lawyer": { city: "denver", topic: "motor-vehicle", label: "Tow Truck Accidents" },
  "denver-truck-accident-lawyer": { city: "denver", topic: "motor-vehicle", label: "Truck Accidents" },
  "denver-ups-truck-accident-lawyer": { city: "denver", topic: "motor-vehicle", label: "UPS Truck Accidents" },
  "denver-uninsured-and-underinsured-motorcyclist-accident-lawyer": { city: "denver", topic: "motor-vehicle", label: "Uninsured & Underinsured Motorists" },
  ...
  "10-things-to-do-after-a-slip-and-fall-accident": { city: "denver", topic: "premises", label: "10 Things to Do After a Fall", resource: true },
  "what-are-colorados-slip-and-fall-laws": { city: "denver", topic: "premises", label: "Colorado Slip and Fall Laws", resource: true },
  "denver-construction-accident-attorney": { city: "denver", topic: "premises", label: "Construction Accidents" },
  "denver-daycare-injury-lawyers": { city: "denver", topic: "premises", label: "Daycare Injuries" },
  ...
  "should-you-hire-a-lawyer-for-a-slip-and-fall-injury-case": { city: "denver", topic: "premises", label: "Hiring a Slip and Fall Lawyer", resource: true },
  ...
  "highlands-ranch-personal-injury-attorney": { city: "highlands-ranch", topic: "other", label: "Personal Injury Overview" },
  ...
  "lakewood-personal-injury-attorney": { city: "lakewood", topic: "other", label: "Personal Injury Overview" },
  ...
  "thornton-personal-injury-attorney": { city: "thornton", topic: "other", label: "Personal Injury Overview" },
