 ...
 */
/**
 * A REASON HERE IS DOCUMENTATION, AND 28 OF THEM WERE WRONG.
 *
 * Every live page must be in this map or in `PRACTICE_AREA_PAGES`, and the
 * importer throws otherwise — that is the anti-silent-drop guarantee. But the
 * REASON is the only thing a later reader has to go on, and "community
 * involvement write-up" had been applied to 23 attorney and staff BIO pages,
 * three former staff, and two WordPress scratch pages. The exclusions were all
 * correct; the explanation was not, which is worse than none on a map whose
 * whole job is to say why.
 *
 * Found by auditing what the live /community-involvement/ page links, not by
 * anything in the build — nothing here checks a reason against reality.
 *
 * THE 24 THAT REALLY ARE WRITE-UPS ARE NOW REDIRECTS. They are live, they were
 * linked from the firm's own community page, and nothing here served or
 * redirected them — 24 URLs that would have 404'd at cutover. See
 * `COMMUNITY_WRITE_UPS` in `src/data/redirects.ts`.
 */
export const EXCLUDED_SLUGS = {
  ...
  "abby-houk": "team member — bio page, served under /meet-our-attorneys/",
  "about": "site page",
  "alexandra-petroff": "former staff — deleted from the roster by request, no bio page here",
  "amy-rogers": "team member — bio page, served under /meet-our-attorneys/",
  "announcements": "site page",
  "ashley-reisman": "team member — bio page, served under /meet-our-attorneys/",
  ...
  "brittany-freeman": "team member — bio page, served under /meet-our-attorneys/",
  "brittany-lesmeister": "team member — bio page, served under /meet-our-attorneys/",
  ...
  "cindy-waller": "team member — bio page, served under /meet-our-attorneys/",
  ...
  "david-garber": "team member — bio page, served under /meet-our-attorneys/",
  ...
  "dinorah-gutierrez": "former staff — deleted from the roster by request, no bio page here",
  ...
  "ella-nelson": "former staff — deleted from the roster by request, no bio page here",
  ...
  "greg-bentley": "team member — bio page, served under /meet-our-attorneys/",
  ...
  "jessica-ayala": "team member — bio page, served under /meet-our-attorneys/",
  "jessica-mauser": "team member — bio page, served under /meet-our-attorneys/",
  "julie-altenhofen": "team member — bio page, served under /meet-our-attorneys/",
  "k-c-harpring": "team member — bio page, served under /meet-our-attorneys/",
  "kassandra-burival": "team member — bio page, served under /meet-our-attorneys/",
  "landing-page": "WordPress scratch page",
  "laura-browne": "team member — bio page, served under /meet-our-attorneys/",
  "leana-kim": "team member — bio page, served under /meet-our-attorneys/",
  "livi-lesch": "team member — bio page, served under /meet-our-attorneys/",
  "maddy-ricciardi": "team member — bio page, served under /meet-our-attorneys/",
  "marcie-emch": "team member — bio page, served under /meet-our-attorneys/",
  "marilyn-morales": "team member — bio page, served under /meet-our-attorneys/",
  "meet-our-attorneys": "site page",
  "michael-greer": "team member — bio page, served under /meet-our-attorneys/",
  "most-common-injuries-caused-by-car-accidents": "article, not a practice area — imported into the BLOG, see PAGE_ARTICLES",
  "new-homepage": "WordPress scratch page",
  "new-homepage-v2": "WordPress scratch page",
  ...
  "rachel-pavelko": "team member — bio page, served under /meet-our-attorneys/",
  "results": "site page",
  "reviews": "site page",
  "sean-dormer": "team member — bio page, served under /meet-our-attorneys/",
  ...
  "thank-you": "site page",
  "tim-garvey": "team member — bio page, served under /meet-our-attorneys/",
